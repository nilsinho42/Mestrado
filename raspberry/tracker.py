...
class DeepSortTracker:
    ...
    def __init__(self, model_path="yolo11n.pt", max_age=70, n_init=5, conf=0.5, use_features=True, max_iou_distance=0.7):
        ...
        self.people_tracker = DeepSort(embedder='torchreid', embedder_gpu=False, half=False, bgr=True, n_init=12, max_age=150, nn_budget=120, max_cosine_distance=0.5, max_iou_distance=0.6) 
